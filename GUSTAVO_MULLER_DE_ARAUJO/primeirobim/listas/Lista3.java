package primeirobim.listas; //cd .. para poder commitar aí fica apenas primeirobim/
          ...
          do {
               ...
               switch (escolha) {
                    case 1:
                         ...
                         System.out.println("Insira o dia de 1 a 30: ");
                         ...
                         if (mes < 1 || mes > 12 || dia < 1 || dia > 30) {
                              ...
                              if (qntdPlanta <= 0 || valorPlanta <= 0) {
                                   ...
                                   if (qntdPlanta > 10) {
                                        ...
                                        matrizVendas[mes - 1][dia - 1] += valorDesconto;
                    ...
                    case 4:
                         ...
                         if (mesConsulta < 1 || mesConsulta > 12 || diaConsulta < 1 || diaConsulta > 30) {
                              System.out.println("Data inválida");
                              System.out.println();
                         } else {
                              System.out.println(
                                        "No dia " + diaConsulta + " do mês " + mesConsulta
                                                  + " o valor da venda foi de: "
                                                  + matrizVendas[mesConsulta - 1][diaConsulta - 1] + " reais");
                              System.out.println();
                         }
                         break;
